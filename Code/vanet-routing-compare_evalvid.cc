...
NS_LOG_COMPONENT_DEFINE ("vanet-routing-compare_evalvid");
  ...
  for (uint32_t i = 0; i < m_nSinks; i++)
    {
      ...
      //Inserting the video for the scenario
...
VanetRoutingExperiment::VanetRoutingExperiment ()
  : m_port (9),
    ...
    m_80211mode (1),
    m_traceFile (""),
    m_logFile ("/home/stelios/mobility.tcl"),
    m_mobility (1),
    m_nNodes (156),
    m_TotalSimTime (300.01),
    m_rate ("2048bps"),
...
static ns3::GlobalValue g_traceFile ("VRCtraceFile",
                                     ...
                                     ns3::StringValue ("/home/stelios/mobility.tcl"),
                                     ns3::MakeStringChecker ());
...
VanetRoutingExperiment::Run ()
{
  ...
  AnimationInterface anim2 ("animation_final_experiment1-sumo.xml");
...
/*       std::cout<<"Flow ID: " << iter->first << " Src Addr " << t.sourceAddress << " Dst Addr " << t.destinationAddress<<"\n";
      ...
      /* index   MCS  Rate (Mb/s) Tput (Mb/s) Received Signal (dBm)Noi+Inf(dBm) SNR (dB)
       ...
       flowmon->SerializeToXmlFile ("/home/stelios/sumo/tools/2022-05-25-16-02-29/flow.xml", true, true);
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      // Realistic vehicular trace in Katerini
      // "low density, 100 total vehicles"
      m_traceFile = "/home/stelios/mobility.tcl";
        m_logFile = "mobility.log";
      m_mobility = 1;
      m_nNodes = 100;
      m_TotalSimTime = 30.00;
      m_nodeSpeed = 10;
      m_nodePause = 0;
      m_CSVfileName = "vanet-routing.output.csv";
      m_CSVfileName = "vanet-routing.output2.csv";
    }
}
