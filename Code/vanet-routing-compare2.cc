...
VanetRoutingExperiment::Run ()
{
  ...
  CheckThroughput ();
  //ns3::WifiPhy::WifiPhy();
  AnimationInterface anim ("/home/doutorado/sumo/examples/fanet/animation-vanet-exp1.xml");
...
/*       std::cout<<"Flow ID: " << iter->first << " Src Addr " << t.sourceAddress << " Dst Addr " << t.destinationAddress<<"\n";
      ...
      /* index   MCS  Rate (Mb/s) Tput (Mb/s) Received Signal (dBm)Noi+Inf(dBm) SNR (dB)
       ...
       flowmon->SerializeToXmlFile ("/home/doutorado/sumo/examples/fanet/vanetExperiment1.xml", true, true);
